...
import { validateBodyCode, validateQueryCode, getUserFromReq, validateBodyCodes } from "../middlewares";
...
timetableRouter.put("/", validateBodyCodes, async (req: AuthRequest, res, next) => {
  try {
    const { courseCodes } = req.body;
